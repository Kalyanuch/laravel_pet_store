...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/plugins/OwlCarousel2-2.2.1/owl.theme.default.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/plugins/OwlCarousel2-2.2.1/animate.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/styles/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/styles/media.css') }}">
</head>
<body>
...
<div class="super_container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="logo"><a href="{{ route('front.homepage') }}">Sublime.</a></div>
                            <nav class="main_nav">
                                <ul>
                                    <li class="@if(Route::is('front.homepage')) active @endif">
                            ...
                            <div class="header_extra ml-auto">
                                <div class="shopping_cart">
                                    <a href="{{ route('front.cart') }}">
                                        ...
                                        <div>{{ __('front.text_cart') }} <span>(0)</span></div>
                                    </a>
                                </div>
                                <div class="search">
                ...
                <div class="row">
                    <div class="col">
                        <div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
                            <form action="#">
                                <input type="text" class="search_input" placeholder="{{ __('front.text_search') }}" required="required">
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="menu_container menu_mm">
            <div class="page_menu_content">
                ...
                <div class="page_menu_search menu_mm">
                    <form action="#">
                        <input type="search" required="required" class="page_menu_search_input menu_mm" placeholder="{{ __('front.text_search_mobile') }}">
                    </form>
                </div>
    ...
    <footer class="footer">
        <div class="footer_background" style="background-image:url(assets/front/images/footer.jpg)"></div>
        <div class="container">
            <div class="row">
                <div class="col">
...
<script src="{{ asset('assets/front/plugins/greensock/TweenMax.min.js') }}"></script>
<script src="{{ asset('assets/front/plugins/greensock/TimelineMax.min.js') }}"></script>
<script src="{{ asset('assets/front/plugins/scrollmagic/ScrollMagic.min.js') }}"></script>
<script src="{{ asset('assets/front/plugins/greensock/animation.gsap.min.js') }}"></script>
<script src="{{ asset('assets/front/plugins/greensock/ScrollToPlugin.min.js') }}"></script>
...
<script src="{{ asset('assets/front/plugins/parallax-js-master/parallax.min.js') }}"></script>
