        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        {{ \Diglactic\Breadcrumbs\Breadcrumbs::view('admin.common.breadcrumbs', 'admin_category_add') }}
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                        ...
                        <div class="form-group">
                            ...
                            <select name="parent_id" class="form-control" id="parent_category">
                                ...
                                @foreach($parent as $item)
                                    <option value="{{ $item->id }}" @if(old('parent_id') == $item->id) selected="selected"@endif>{{ $item->title }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
